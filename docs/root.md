...
(see [Consumer integration](features/consumer-integration/feature.md)).
...
- [Control API](features/control-api/feature.md) — HTTP endpoints, the create-job
  request/response contracts, the per-job snapshot, and the SSE event stream.
- [Transcode engine](features/transcode-engine/feature.md) — the `FfmpegTranscodeEngine`:
  the job queue and worker loops, lifecycle, ffmpeg argument construction, progress
  parsing, and state→event mapping.
- [Hardware acceleration](features/hardware-acceleration/feature.md) — VAAPI / VideoToolbox /
...
- [Hosty runtime app](features/hosty-runtime-app/feature.md) — the manifest, the four
...
- [Configuration](features/configuration/feature.md) — the full environment-variable
  reference.
- [Build and deployment](features/build-and-deployment/feature.md) — the Dockerfile, the
...
- **compression-controls** — [feature](features/compression-controls/feature.md)
...
- **dolby-vision-conversion** — [feature](features/dolby-vision-conversion/feature.md)
- **extract-jobs** — [feature](features/extract-jobs/feature.md)
- **hardware-acceleration** — [feature](features/hardware-acceleration/feature.md)
- **hosty-runtime-app** — [feature](features/hosty-runtime-app/feature.md)
- **merge-jobs** — [feature](features/merge-jobs/feature.md)
- **probe-api** — [feature](features/probe-api/feature.md)
- **transcode-engine** — [feature](features/transcode-engine/feature.md)
- **video-part-joining** — [feature](features/video-part-joining/feature.md)

### Legacy documents (pre-migration)

- [features/media-mounts](features/media-mounts.md) — Implemented
